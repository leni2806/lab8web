...
```
lab8_php_database/
├── koneksi.php        # Halaman utama - menampilkan daftar barang
├── index.php          # Form tambah data barang baru
├── tambah.php         # Form edit data barang
├── ubah.php           # Proses hapus data barang
├── hapus.php          # File konfigurasi koneksi database
